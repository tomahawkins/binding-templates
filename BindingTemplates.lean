...
def svg (d : Drawing) : String :=
  let headers : List String := [
    ...
    s!"<svg xmlns=\"http://www.w3.org/2000/svg\" version=\"1.2\" width=\"{pageWidth}mm\" height=\"{pageHeight}mm\" viewBox=\"0 0 {pageWidth} {pageHeight}\" style=\"background-color:white\">",
    "<style>",
    ".small { font: 6px sans-serif; }",
    "</style>"
  ]
  "\n".intercalate (headers ++ d.elements.map ("  " ++ .) ++ ["</svg>"])
