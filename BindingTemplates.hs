...
generateTemplateLibrary = do
  ...
  forM_ [36 .. 50] $ \euroSize -> do
    ...
    writeFile ("rossignol-ifp/rossignol-ifp-euro-" <> show euroSize <> ".svg")
      $ unpack
      $ svg
      $ template [PlacePlate (rossignolIFP euroSize) 0]
...
pivotHeel = HeelBinding [Pair 21 82, Pair 29 (82 - 32)]


-- | Look SPX heel.
spxHeel :: HeelBinding
spxHeel = HeelBinding [Pair 42 26, Pair 42 (26 - 105)]


-- | Look Rockerace heel.
rockeraceHeel :: HeelBinding
rockeraceHeel = HeelBinding [Pair 42 59, Pair 42 (59 - 39)]


-- | Look toe.
lookToe :: ToeBinding
lookToe = ToeBinding [Pair 35 (-16.5), Pair 42 (-16.5 + 41.5)]


-- | Look R20 racing plate toe.
lookR20Toe :: ToeBinding
lookR20Toe = ToeBinding [Pair 37 (-(16.5 + 33)), Pair 35 (110 - (16.5 + 33))]


-- | Look R20 racing plate heel.
lookR20Heel :: HeelBinding
lookR20Heel = HeelBinding [Pair 34 (47.5 + 26), Pair 36 (47.5 + 26 - 119)]
...
-- | Salomon Shift.
shiftToe :: ToeBinding
shiftToe = ToeBinding [Center (-20 + 65), Pair 30 (-20 - 70)]

shiftHeel :: HeelBinding
shiftHeel = HeelBinding [Pair 36 15, Pair 36 (15 - 68)]


-- | Salomon STH2.
sth2Toe :: ToeBinding
sth2Toe = ToeBinding [Pair 42 (-15 + 30), Pair 40 (-15)]

sth2Heel :: HeelBinding
sth2Heel = HeelBinding [Pair 32 28, Pair 32 (28 - 75)]


-- | Salomon Warden toe.
wardenToe :: ToeBinding
wardenToe = ToeBinding [Pair 40 (-15 + 65), Pair 40 (-15)]


-- | Marker Royal family (Jester, Griffon, Squire).
royalToe :: ToeBinding
royalToe = ToeBinding [Pair 36 (-12 + 31), Pair 36 (-12)]

royalHeel :: HeelBinding
royalHeel = HeelBinding [Pair 32 25, Pair 32 (25 - 80)]


-- | Tyrolia.
tyroliaToe :: ToeBinding
tyroliaToe = ToeBinding [Pair 40 (-15 + 55), Pair 40 (-15)]

tyroliaHeel :: HeelBinding
tyroliaHeel = HeelBinding [Pair 20 17, Pair 42.5 (17 - 95)]
...
template placements =
  centerLines <> scalingRulers <> mconcat (placement <$> placements)
